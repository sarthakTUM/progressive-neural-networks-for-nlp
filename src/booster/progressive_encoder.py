...
class CharEncoder(Encoder):
    ...
    def __init__(self, path=None, max_word_length=30):
...
class WordEncoder(Encoder):
    ...
    def create_map(self, data_iterators):
        if self.type == 'fasttext':
            ...
            idx = 2
            fin = io.open(self.vocab_path, 'r', encoding='utf-8', newline='\n', errors='ignore')
