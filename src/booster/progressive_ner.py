...
parser.add_argument('--data_dir', default='../ner/data/dj_iobes_id', help="Directory containing the dataset")
parser.add_argument('--model_dir', default='../ner/experiments/disease/pnn_fracs/dj/germeval_pnn_dj_100', help="Directory containing params.json")
...
if __name__ == '__main__':
    ...
    optimizer = optim.SGD(params=filter(lambda p: p.requires_grad,
                          ...
                          lr=0.015,
                          momentum=0.9)
    # optimizer = optim.Adam(params=filter(lambda p: p.requires_grad, progNet.parameters()))
