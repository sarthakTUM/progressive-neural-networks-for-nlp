...
if __name__ == '__main__':
    ...
    """
    change the model directories accordingly.
    """
    c1_model_dir = '../tc/experiments/st_fracs/organic/st_100_save'
    c2_model_dir = '../tc/experiments/st_fracs/kitchen_housewares/st_100_save'
    ...
    logging.info('c1 model: {}'.format(c1_model_dir))
    logging.info('c2 model: {}'.format(c2_model_dir))
    ...
    c1_model = CNNTC(num_tags=c1_label_encoder[ClassEncoder.FEATURE_NAME].num_tags,
    ...
    c2_model = CNNTC(num_tags=c2_label_encoder[ClassEncoder.FEATURE_NAME].num_tags,
    ...
    c3_model = CNNTC(num_tags=label_encoder[ClassEncoder.FEATURE_NAME].num_tags,
    ...
    column_1 = Column(model=c1_model,
                      layers={'conv3': (100, 600),
                              'fc_1': (600, 128),
                              'fc_2':  (128, c1_label_encoder[ClassEncoder.FEATURE_NAME].num_tags)},
                      data_loader=c1_data_loader).to(device)

    column_2 = Column(model=c2_model,
                      layers={'conv3': (100, 600),
                              'fc_1': (600, 128),
                              'fc_2':  (128, c2_label_encoder[ClassEncoder.FEATURE_NAME].num_tags)},
