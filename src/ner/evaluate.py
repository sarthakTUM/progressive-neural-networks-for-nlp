...
parser.add_argument('--data_dir', default='data/ncbi', help="Directory containing the dataset")
parser.add_argument('--model_dir', default='experiments/ncbi', help="Directory containing params.json")
